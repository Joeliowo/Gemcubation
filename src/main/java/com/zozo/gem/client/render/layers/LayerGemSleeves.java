...
public class LayerGemSleeves extends EntityLayer implements LayerRenderer<EntityGem> {
    public final RenderLivingBase<?> renderer;
    public final ModelBase model;

    public LayerGemSleeves(RenderLivingBase<?> renderer) {
    ...
    public ResourceLocation getEntityTexture(EntityGem gem){
        ...
        return new ResourceLocation(location.getResourceDomain() + ":textures/entities/" + this.getName(gem) + "/sleeves.png");
    }
