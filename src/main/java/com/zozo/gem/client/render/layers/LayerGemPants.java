...
public class LayerGemPants extends EntityLayer implements LayerRenderer<EntityGem> {
    public final RenderLivingBase<?> renderer;
    public final ModelBase model;

    public LayerGemPants(RenderLivingBase<?> renderer) {
    ...
    public ResourceLocation getEntityTexture(EntityGem gem){
        ...
        return new ResourceLocation(location.getResourceDomain() + ":textures/entities/" + this.getName(gem) + "/pants.png");
    }
